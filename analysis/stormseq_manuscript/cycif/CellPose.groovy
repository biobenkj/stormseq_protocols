...
def cellpose = Cellpose2D.builder( pathModel )
        ...
        .setOverlap(60)
        .channels( 13,15 )	               // Select detection channel(s)
...
def min_nuc_intensity=1000 //remove any detections with an intensity less than or equal to this value
nuc_intensity_measurement='DAPI_R4 (C16): Mean'
def toDelete = getDetectionObjects().findAll {measurement(it, nuc_intensity_measurement) <= min_nuc_intensity}
removeObjects(toDelete, true)

runObjectClassifier("Dual_positive_cells");